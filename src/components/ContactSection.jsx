      ...
      <div className="relative z-10 mt-24 border-t border-white/10 pt-12 pb-8">
        <div className="relative flex flex-col items-center gap-7">
          ...
          <div className="flex flex-wrap items-center justify-center gap-5">
            {/* Instagram */}
            <a
              href="https://www.instagram.com/yedu__krish"
              target="_blank"
              rel="noopener noreferrer"
            ...
            {/* GitHub */}
            <a
              href="https://github.com/yedu-krish05"
              target="_blank"
              rel="noopener noreferrer"
              aria-label="GitHub"
              className="group relative grid h-14 w-14 place-items-center overflow-hidden rounded-[20px]
            ...
            {/* LinkedIn */}
            <a
              href="https://www.linkedin.com/in/yedu-krishnan-331baa2a2"
              target="_blank"
              rel="noopener noreferrer"
              aria-label="LinkedIn"
              className="group relative grid h-14 w-14 place-items-center overflow-hidden rounded-[20px]
            ...
            >
              ...
              <FaLinkedinIn className="relative z-10 text-[30px] text-white transition-all duration-500 group-hover:scale-110 group-hover:text-sky-400" />
            </a>
          </div>
